...
#if !OSL_GPU_DEVICE_COMPILE && !defined(OSL_COMPILING_TO_BITCODE)
    Color Cout;
...
#endif  // !OSL_GPU_DEVICE_COMPILE && !defined(OSL_COMPILING_TO_BITCODE)
...
// On GPU, this will be defined by the renderer. Otherwise inline a getter.
#if OSL_GPU
